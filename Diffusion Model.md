...
* [3 Specific Applications of Diffusion Models](#3-specific-applications-of-diffusion-models)
  ...
  * [3.2 Physical Control Systems & Planning](#32-physical-control-systems--planning)
...
<p align="center">
<img src="./assets/Diffusion_trained_on_2-d_swiss_roll_data.png" alt="Figure 1. The proposed modeling framework trained on 2-d swiss roll data." width="600">
</p>
...
<p align="center">
<img src="./assets/Score-based_modeling_framework.png" alt="Figure 2. The proposed score-based modeling framework with score matching and Langevin dynamics." width="600">
</p>
...
<p align="center">
<img src="./assets/Improved_score-based_modeling_framework.png" alt="Figure 3. The improved score-based modeling framework with denosing score matching and annealed Langevin dynamics." width="600">
</p>
...
<p align="center">
<img src="./assets/Directed_graphical_model_considered_in_DDPM.png" alt="Figure 4. The directed graphical model considered in DDPM." width="600">
</p>
...
<p align="center">
<img src="./assets/From_variational_inference_to_denoising_score_matching.png" alt="Figure 5. From variational inference to denoising score matching." width="600">
</p>
...
<p align="center">
<img src="./assets/Algorithms_in_DDPM.png" alt="Figure 6. Algorithms in DDPM." width="800">
</p>
...
<p align="center">
<img src="./assets/Reverse-time_SDE.png" alt="Figure 7. Solving a reverse-time SDE yields a score-based generative model." width="700">
</p>
...
<p align="center">
<img src="./assets/Overview_of_score-based_generative_modeling_through_SEDs.png" alt="Figure 8. Overview of score-based generative modeling through SEDs." width="800">
</p>
...
<p align="center">
<img src="./assets/Skip-step_Diffusion.png" alt="Figure 9. Graphical models for diffusion(left) and non-Markovian(right) inference models." width="800">
</p>
...
<p align="center">
<img src="./assets/DDIM_example.png" alt="Figure 10. Graphical model for accelerated generation, where \$\tau=\[1, 3\]\$" width="500">
</p>
...
<p align="center">
<img src="./assets/Classifier_guided_diffusion_and_ddim_sampling.png" alt="Figure 13. Algorithm 1 Classifier guided diffusion and DDIM sampling." width="700">
</p>
...
<p align="center">
<img src="./assets/Diffusion_with_classifier-free_guidance.png" alt="Figure 15. Algorithm 1 Joint training a diffusion model with classifier-free guidance." width="700">
</p>

采样时，他们使用条件与无条件 score 估计的线性组合进行生成。

<p align="center">
<img src="./assets/Conditional_sampling_with_classifier-free_guidance.png" alt="Figure 16. Algorithm 2 Conditional sampling with classifier-free guidance." width="700">
</p>
...
<p align="center">
<img src="./assets/Illustrating_perceptual_and_semantic_compression.png" alt="Figure 17. Illustrating perceptual and semantic compression." width="600">
</p>
...
<p align="center">
<img src="./assets/Coditional_LDMs.png" alt="Figure 18. Condition LDMs either via concatenation or by a more general cross-attention mechanism." width="700">
</p>
...
<a id="32-physical-control-systems--planning"></a>

## 3.2 Physical Control Systems & Planning
...
<p align="center">
<img src="./assets/CSDI.png" alt="Figure 19. CSDI." width="800">
</p>
...
<p align="center">
<img src="./assets/Diffusers.png" alt="Figure 20. Planning with Decision Diffuser." width="700">
</p>
...
<p align="center">
<img src="./assets/Policy_Representations.png" alt="Figure 21. Policy Representations." width="600">
</p>

<p align="center">
<img src="./assets/Diffusion_Policy_Overview.png" alt="Figure 22. Diffusion policy Overview." width="600">
</p>
...
<p align="center">
<img src="./assets/Diffuse-CLoC's_3_stages.png" alt="Figure 23. Diffuse-CLoC's 3 stages." width="700">
</p>
...
<p align="center">
<img src="./assets/Framework_of_Diffuse-CLoC.png" alt="Figure 24. Framework of Diffuse-CLoC." width="700">
</p>
...
<p align="center">
<img src="./assets/Framework_of_Unet.png" alt="Figure 25. Framework of Unet." width="700">
</p>
...
✔ 总结：**定位信息=浅层特征提供**；**语义信息=深层特征提供**；**decoder = 融合它们并输出高分辨率预测**

U-Net 之所以能定位，是依靠 skip connections 把浅层卷积学到的原始空间细节传递过来。
